          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">SİPARİŞLER TABLOSU</h3>
...
while ($sipariscek=$siparis->fetch(PDO::FETCH_ASSOC)) { ?>
                    <tr>
                      ...
                      <td><a href="islem/islem.php?siparisonayla&id=<?php echo $sipariscek['siparis_id'] ?>"><button type="submit" class="btn btn-success">Onayla</button></td>
                      ...
                      <td><a href="islem/islem.php?siparisreddet&id=<?php echo $sipariscek['siparis_id'] ?>"><button type="submit" class="btn btn-danger">Sil</button></a></td>
