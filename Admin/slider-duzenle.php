              ...
              <form action="islem/islem.php" method="POST" enctype="multipart/form-data" >
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input value="<?php echo $slidercek['slider_baslik'] ?> " name="sliderbaslik" type="text" class="form-control"  placeholder="Lütfen slider başlık  giriniz.">
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <input value="<?php echo $slidercek['slider_button'] ?> " name="sliderbutton" type="text" class="form-control"  placeholder="Lütfen slider button giriniz.">
                  </div>
                  ...
                  <select name="sliderdurum" class="form-control select2" style="width: 100%;">
                    ...
                    <option <?php if ($slidercek['slider_durum']=="0") {
                      echo "selected";
                    } ?>value="0" selected="selected">Pasif</option>
...
<input type="hidden" name="eskiresim" value="<?php echo $slidercek['slider_resim'] ?>">
                  ...
                  <select name="sliderbanner" class="form-control select2" style="width: 100%;">
                    ...
                    <option <?php if ($slidercek['slider_banner']=="0") {
                      echo "selected";
                    } ?>value="0" selected="selected">Banner yap</option>
