          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">KATEGORİ TABLOSU</h3>
...
while ($kategoricek=$kategori->fetch(PDO::FETCH_ASSOC)) { ?>
                    <tr>
                      ...
                      <td><a href="kategori-duzenle?id=<?php echo $kategoricek['kategori_id'] ?>"><button type="submit" class="btn btn-info">Düzenle</button></td>
