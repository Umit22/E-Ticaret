          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">SLİDER TABLOSU</h3>
...
while ($slidercek=$slider->fetch(PDO::FETCH_ASSOC)) { ?>
                    <tr>
                      <td><img style="width: 170px;" src="resimler/slider/<?php echo $slidercek['slider_resim'] ?>"></td>
                      ...
                      <td><a href="slider-duzenle?id=<?php echo $slidercek['slider_id'] ?>"><button type="submit" class="btn btn-info">Düzenle</button></td>
