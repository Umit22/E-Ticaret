...
$kullanicisor=$baglanti->prepare("SELECT * from kullanici where kullanici_adi=:kullanici_adi && kullanici_sifre=:kullanici_sifre and kullanici_yetki=:kullanici_yetki");
